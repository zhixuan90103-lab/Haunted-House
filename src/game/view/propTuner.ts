...
const SLIDERS: SliderDef[] = [
  ...
  { group: 'view', key: 'ghostPivotY', label: '鬼质心Y%', min: 40, max: 100, step: 1 },
  { group: 'view', key: 'ghostIdleAmp', label: '待机幅度px', min: 0, max: 16, step: 1 },
  { group: 'view', key: 'ghostIdlePeriodMs', label: '待机周期ms', min: 800, max: 3600, step: 50 },
